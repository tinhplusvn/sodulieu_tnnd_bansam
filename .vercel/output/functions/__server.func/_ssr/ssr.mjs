...
import { A as resolveManifestCssLink, B as isNotFound, D as getScriptPreloadAttrs, I as isRedirect, L as isResolvedRedirect, M as executeRewriteInput, N as invariant, O as getStylesheetHref, S as require_jsx_runtime, a as isSsrResponse, c as stripSsrResponseBody, i as disposeSsrResponseDetached, j as _getRenderedMatches, k as resolveManifestAssetLink, n as bindSsrResponseToRequest, o as normalizeSsrResponse, p as RouterProvider, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, z as rootRouteId } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cn5b7-1H.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DdJZelVg.mjs").then((n) => n.t),
